...
import (
	orderpb "github.com/freeman7728/gorder-v2/common/genproto/orderpb"
...
var file_stockpb_stock_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x49, 0x74, 0x65, 0x6d, 0x49, 0x44, 0x73, 0x22, 0x37, 0x0a,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x66, 0x72, 0x65, 0x65, 0x6d, 0x61, 0x6e,
	0x37, 0x37, 0x32, 0x38, 0x2f, 0x67, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2d, 0x76, 0x32, 0x2f, 0x63,
...
var file_stockpb_stock_proto_goTypes = []any{
	...
	(*orderpb.ItemWithQuantity)(nil),    // 4: orderpb.ItemWithQuantity
	(*orderpb.Item)(nil),                // 5: orderpb.Item
}
var file_stockpb_stock_proto_depIdxs = []int32{
	4, // 0: stockpb.CheckIfItemsInStockRequest.Items:type_name -> orderpb.ItemWithQuantity
	5, // 1: stockpb.CheckIfItemsInStockResponse.Items:type_name -> orderpb.Item
	5, // 2: stockpb.GetItemsResponse.Items:type_name -> orderpb.Item
	2, // 3: stockpb.StockService.GetItems:input_type -> stockpb.GetItemsRequest
	0, // 4: stockpb.StockService.CheckIfItemsInStock:input_type -> stockpb.CheckIfItemsInStockRequest
	3, // 5: stockpb.StockService.GetItems:output_type -> stockpb.GetItemsResponse
	1, // 6: stockpb.StockService.CheckIfItemsInStock:output_type -> stockpb.CheckIfItemsInStockResponse
